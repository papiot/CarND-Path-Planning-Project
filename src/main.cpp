        ...
        if (event == "telemetry") {
          ...
          currentLane = 2 + 4*lane;
          	...
          	// // TODO: define a path made up of (x,y) points that the car will visit sequentially every .02 seconds
						...
						// for(int i = 0; i < 50; i++)
						// {
						// 	// i+1 to account for the fact that the car is stationary at first
						// 	double next_s = car_s + (i + 1) * dist_inc;

						// 	// 6 is because the lane is 4m widt and we count from middle yellow line
						// 	double next_d = 6;
						...
						// }
						// // END FIRST IMPLEMENTATION (car keeps lane, but is not smooth)
